...
agent.print_response('What are my hobbies?', user_id=user_id, session_id='003')
agent.print_response('List down all the question i asked so far', user_id=user_id, session_id='003')
...
session_summary = memory.get_session_summary(
        user_id=user_id, session_id='003'
    )
